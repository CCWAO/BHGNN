...
class ARMAConv_Bayes(MessagePassing):
    ...
    def __init__(self, in_channels: int, out_channels: int,
        ...
        super(ARMAConv_Bayes, self).__init__(**kwargs)
    ...
    def forward(self, x: Tensor, edge_index: Adj,
        ...
        for t in range(self.num_layers):
            ...
            root_dropout = root @ self.root_weight[0 if self.shared_weights else t]
            out += F.dropout(root_dropout, p=self.dropout, training=True)
